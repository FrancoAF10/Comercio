...
<head>
    ...
    <link rel="stylesheet" href="taller2.css" type="text/css">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
    <title>Bienvenido al Taller 2</title>
...
<div class="imagen">
    <br>
    <div class="titulo">
<h1 align="center">TALLER 2 - CONTABILIDAD</h1>
</div>
...
<form action="/comercio/models/conexion_taller1.php" method="post">
    <div class="buttons-container">
        ...
        <button type="button" class="btn btn-primary" onclick="window.location.href='Agregar_taller2.php'">Nuevo Equipo</button>
    </div>
</form>
...
<form action="excel2.php" method="post">
    ...
    <div class="table-container">
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                $datos = "SELECT Nro_Taller, Nro_Maquina, Monitor, Serie_Monitor, Estado_Monitor, CPU, Serie_CPU,Descripcion_CPU, Estado_CPU, Teclado, Serie_Teclado, Estado_Teclado, Mouse, Serie_Mouse, Estado_Mouse FROM EQUIPOS WHERE Nro_Taller=2 ORDER BY Nro_Maquina ASC";
                ...
                <td><?php echo $mostrar['14']?></td>
                    <td align="center">
                    <form action="/comercio/views/taller02/editar_taller2.php" method="GET">
    ...
    <button type="submit" class="btn btn-outline-primary" id="btn-table">Editar</button>
            ...
            <form action="/comercio/models/conexion_taller1.php" method="POST">
                ...
                <input type="hidden" name="Nro_Maquina" value="<?php echo $mostrar[1]; ?>">
                <button type="submit" class="btn btn-danger" name="Eliminar2" id="btn-table">Eliminar</button>
            </form>
        </td>
                </tr>
                <?php
