...
// Agregar el título "TALLER 2 - CONTABILIDAD" comenzando en la celda B2
$sheet->setCellValue('B2', 'TALLER 2 - CONTABILIDAD');
...
header('Content-Disposition: attachment;filename="Equipos-T2.xlsx"');
