...
// Agregar el título "TALLER 1 - COMPUTACIÓN" comenzando en la celda B2
$sheet->setCellValue('B2', 'TALLER 1 - COMPUTACIÓN');
...
header('Content-Disposition: attachment;filename="Equipos-T1.xlsx"');
