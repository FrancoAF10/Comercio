...
<head>
    ...
    <link rel="stylesheet" href="agregar_t1.css" type="text/css">
...
<br>
    ...
    <div>
            <input type="hidden" name="Nro_Taller" value=1>
        </div>
        <center>
        ...
        <div class="button_agregar" align="center">
            <button type="submit" name="agregar1" href='/comercio/views/taller01/taller1.php'>Agregar</button>
        </div>
