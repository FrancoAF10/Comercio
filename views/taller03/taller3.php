...
<head>
    ...
    <link rel="stylesheet" href="taller3.css" type="text/css">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
    <title>Bienvenido al Taller 3</title>
</head>
<body>
<?php
...
<nav class="navbar navbar-expand-lg navbar-dark">
  ...
  <div class="imagen">
    <br>
    <div class="titulo">
      <h1 align="center">TALLER 3 - SECRETARIADO</h1>
    </div>
...
<form action="/comercio/models/conexion_taller1.php" method="post">
    <div class="buttons-container">
        ...
        <button type="button" class="btn btn-primary" onclick="window.location.href='Agregar_taller3.php'">Nuevo Equipo</button>
    </div>
</form>
...
<form action="excel3.php" method="post">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <td><?php echo $mostrar['14']?></td>
                    <td align="center">
                    <form action="/comercio/views/taller03/editar_taller3.php" method="GET">
    ...
    <button type="submit" class="btn btn-outline-primary" id="btn-table">Editar</button>
            ...
            <form action="/comercio/models/conexion_taller1.php" method="POST">
                ...
                <input type="hidden" name="Nro_Maquina" value="<?php echo $mostrar[1]; ?>">
                <button type="submit" class="btn btn-danger" name="Eliminar3" id="btn-table">Eliminar</button>
            </form>
        </td>
                </tr>
                <?php
